...
''',
    ...
    "frontend/src/main.jsx": '''import React, { useEffect, useMemo, useState } from "react";
...
def write_files():
    print("Adding React Dashboard to FeatureForge...")
    ...
    print("Updated file: backend/app/main.py with CORS enabled.")

    print("\\nReact Dashboard added successfully.")
    print("\\nFrontend commands:")
    print("cd frontend")
    print("npm install")
    print("npm run dev")
